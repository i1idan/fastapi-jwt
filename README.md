...
- 🎯 Entry points to execute your program using `python -m <fastapi_jwt>` or `$ fastapi_jwt` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/i1idan/fastapi-jwt/branch/main/graph/badge.svg?token=fastapi-jwt_token_here)](https://codecov.io/gh/i1idan/fastapi-jwt)
[![CI](https://github.com/i1idan/fastapi-jwt/actions/workflows/main.yml/badge.svg)](https://github.com/i1idan/fastapi-jwt/actions/workflows/main.yml)

Awesome fastapi_jwt created by i1idan

## Install

from source
```bash
git clone https://github.com/i1idan/fastapi-jwt fastapi_jwt
cd fastapi_jwt
make install
```
...
-----------------------------------------------------
fastapi_jwt/__init__.py              4      0   100%
fastapi_jwt/app.py                  16      1    94%
fastapi_jwt/cli.py                  21      0   100%
fastapi_jwt/config.py                5      0   100%
fastapi_jwt/db.py                   10      0   100%
fastapi_jwt/models/__init__.py       0      0   100%
fastapi_jwt/models/content.py       47      1    98%
fastapi_jwt/routes/__init__.py      11      0   100%
fastapi_jwt/routes/content.py       52     25    52%
fastapi_jwt/routes/security.py      15      1    93%
fastapi_jwt/routes/user.py          52     26    50%
fastapi_jwt/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
